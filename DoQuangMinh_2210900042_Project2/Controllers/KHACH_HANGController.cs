...
namespace DoQuangMinh_2210900042_Project2.Controllers
{
    public class KHACH_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Ma_KH,Tai_khoan,Mat_khau,Email,Ho_ten,Dia_chi,PhoneNumber,Trang_thai")] KHACH_HANG kHACH_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Ma_KH,Tai_khoan,Mat_khau,Email,Ho_ten,Dia_chi,PhoneNumber,Trang_thai")] KHACH_HANG kHACH_HANG)
        {
            if (ModelState.IsValid)
            {
