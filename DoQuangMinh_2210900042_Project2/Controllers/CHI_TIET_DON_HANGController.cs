...
namespace DoQuangMinh_2210900042_Project2.Controllers
{
    public class CHI_TIET_DON_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Ma_CTDH,Ma_DH,Ma_SP,So_luong,Gia")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
            ...
            ViewBag.Ma_DH = new SelectList(db.DON_HANG, "Ma_DH", "Ma_DH", cHI_TIET_DON_HANG.Ma_DH);
            ViewBag.Ma_SP = new SelectList(db.SAN_PHAM, "Ma_SP", "Ten_SP", cHI_TIET_DON_HANG.Ma_SP);
            return View(cHI_TIET_DON_HANG);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Ma_CTDH,Ma_DH,Ma_SP,So_luong,Gia")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
            if (ModelState.IsValid)
            {
