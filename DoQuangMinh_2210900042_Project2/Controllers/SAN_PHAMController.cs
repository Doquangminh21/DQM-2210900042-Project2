...
namespace DoQuangMinh_2210900042_Project2.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Ma_SP,Ten_SP,Kich_thuoc,Mau,Gia,Soluongtonkho")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Ma_SP,Ten_SP,Kich_thuoc,Mau,Gia,Soluongtonkho")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
